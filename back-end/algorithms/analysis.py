...
# Тест үгс
# news = ["Miss Universe тэмцээн 1952 онд анх зохиогдож байжээ. Анхны тэмцээнээс 10 гаруй жилийн өмнө төрсөн 80 настай Чой Сун Хва өдгөө тус тэмцээний хамгийн өндөр настай оролцогчоор түүхэнд бичигдэх магадлалтай байна. Тэрбээр энэ сарын эхээр Miss Universe Korea тэмцээний финалд шалгарчээ. Өнөөдөр тэр өөр 31 оролцогчтой өрсөлдөж, арваннэгдүгээр сард Мексикт болох тэмцээнд Өмнөд Солонгосыг төлөөлөх эсэхээ шийднэ."]
# news = news[0] 
# words = news.split(" ")
